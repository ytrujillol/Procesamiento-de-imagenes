...
# ╔═╡ e99032f2-2519-47e5-8a57-79a06007295b
md"""A continuación se muestra una visualización 3D de la Figura 2."""

# ╔═╡ db3e4564-fafb-437c-95e1-52a03407b5c8
begin
	plotly()
	...
	surface(xᵢ, yᵢ, Aᵢ, c = :greys, xlabel="x", ylabel="y", zlabel="z", title="Vista 3D de la imagen")
end
