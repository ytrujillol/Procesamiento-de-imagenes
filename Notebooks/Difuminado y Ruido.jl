...
md"""
# Difuminado de Imágenes y Reducción de Ruido
"""

# ╔═╡ 91d069c9-ba7a-458b-b1ba-95e84fe84b45
md"""##   $\cdot$ Aplicaciones"""

# ╔═╡ c390e77b-f57c-43a4-91a9-f0ecc0f65381
md"""
...
# ╔═╡ 79608b4a-fd81-4826-b6f0-7a8f0a29b686
md"""
...
# ╔═╡ b92f6a97-09ad-4385-9c2a-25c0af8b1d33
md"""
...
md"""
Con $\sigma = 1$ evaluamos cada vecindad en la funcion $g(x,y)$ para obtener la matriz de pesos.
"""
...
md"""
Vemos que $2* 0.0293 \approx 0.0585$, $3*0.0293 = 0.0878 \approx 0.0965$ y $5*0.0293 = 0.1464 \approx 0.1592$ y de esta forma a nuestra conveniencia tal que la suma de todas las entradas den 1 obtenemos la matriz de pesos.
"""

# ╔═╡ 81d12755-88dd-42e9-aa2c-e8e9a74f2845
md"""
...
[T1 imagen_difuminada(T1)]

# ╔═╡ 5fed002f-0a43-4fb1-99a4-fb18aa9674ea
[T2 imagen_difuminada(T2) imagen_difuminada_pesos(T2)]

# ╔═╡ 490055bf-cf98-4e51-81ea-822c8db1a9ce
[T3 imagen_difuminada(T3) imagen_difuminada_pesos(T3)]
...
manifest_format = "2.0"
project_hash = "18ff8a2dbdc6d421d5192bce708242da019c8b63"
